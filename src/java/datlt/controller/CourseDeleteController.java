...
public class CourseDeleteController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            int deletingID = Integer.parseInt(request.getParameter("pk"));
            CourseDAO courseDAO = new CourseDAO();
            courseDAO.deleteByPrimaryKey(deletingID);

            courseDAO.getAllCourse();
            List<CourseDTO> courseList = courseDAO.getListCourse();
            ...
            Logger.getLogger(CourseDeleteController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
